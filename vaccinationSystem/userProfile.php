  ...
  <div class="account-info">
    ...
    <form action="./processes/profileUpdateProcess.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" id="full-name" name="full_name" placeholder="Full Name" value="<?php echo $_SESSION["user"]["name"]; ?>"
          required>
      </div>
      <div class="form-group">
        <label for="address">Address</label>
        <input type="text" id="address" name="address" placeholder="Address" value="<?php echo $_SESSION["user"]["address"]; ?>"
          required>
      </div>
      <div class="form-group">
        <label for="nic">NIC Number</label>
        <input type="text" id="nic" name="nic" placeholder="NIC Number" value="<?php echo $_SESSION["user"]["nic"]; ?>" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="date" id="birth-date" name="dob" placeholder="DD/MM/YYYY" value="<?php echo $_SESSION["user"]["dob"]; ?>"
          required>
      </div>
      <div class="form-group">
        <label for="phone">Phone</label>
        <input type="text" id="phone" name="mobile" placeholder="Phone" value="<?php echo $_SESSION["user"]["mobileNo"]; ?>" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="password" id="password" name="password" value="<?php echo $_SESSION["user"]["password"]; ?>" required>
      </div>
      <div class="form-group">
